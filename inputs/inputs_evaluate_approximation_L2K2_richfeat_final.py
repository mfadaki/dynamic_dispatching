"""
inputs/inputs_evaluate_approximation_L2K2.py
=============================================
...
NO_BASIS_FN = L_AGE + N_LABS + 4     # const + L_AGE depot-age + aggregate lab_shortfall + N_LABS per-lab shortfall + imbalance + exp_risk
_B = NO_BASIS_FN
